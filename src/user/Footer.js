  ...
  return (
    ...
    <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
      <div className="flex flex-col items-center border-t pt-6">
        ...
        <Link to="/Services" className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Services</Link>
        <Link to="/Product" className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Products</Link>
      ...
      <div className="py-8 text-center text-sm text-gray-400">© 2021 - Mobile Wallet. All rights reserved.</div>
    </footer>
  </div>
    </div>
  )
